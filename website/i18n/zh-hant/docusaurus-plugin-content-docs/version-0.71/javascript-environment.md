...
- 使用 Chrome 調試時，所有 JavaScript 程式碼會在 Chrome 瀏覽器內執行，並透過 WebSockets 與原生程式碼通訊。Chrome 使用 [V8](https://v8.dev/) 作為 JavaScript 引擎。
...
完整的 React Native 轉換功能清單可查閱 [@react-native/babel-preset](https://github.com/facebook/react-native/tree/main/packages/react-native-babel-preset)。
