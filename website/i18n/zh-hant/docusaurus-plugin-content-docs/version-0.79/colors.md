...
- [PlatformColor](platformcolor) 讓您能參照平台的色彩系統。
...
:::caution
這可能看似與 Android 的 [Color](https://developer.android.com/reference/android/graphics/Color) 整數表示法相似，但在 Android 上，數值是以 SRGB 色彩模式儲存 (0xaarrggbb)。
:::
