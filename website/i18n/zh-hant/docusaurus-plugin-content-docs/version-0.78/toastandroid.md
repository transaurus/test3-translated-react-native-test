...
`showWithGravityAndOffset(message, duration, gravity, xOffset, yOffset)` 方法則增加了以像素為單位的偏移量設定功能。

> 從 Android 11（API 級別 30）開始，設定重力對文字提示不再有效。請參閱[此處](https://developer.android.com/about/versions/11/behavior-changes-11#text-toast-api-changes)了解相關變更。
