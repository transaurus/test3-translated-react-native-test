...
請使用 [React Native Upgrade Helper](https://react-native-community.github.io/upgrade-helper/) 來查看現有專案在 React Native 版本之間的程式碼變更，並參考[升級文件](/docs/upgrading)。你也可以使用 `npx react-native@latest init MyProject` 建立一個新專案。
